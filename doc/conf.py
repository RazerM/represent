...
htmlhelp_basename = 'representdoc'
...
latex_documents = [
    ('index', 'Represent.tex', 'Represent Documentation', AUTHOR, 'manual'),
]
...
man_pages = [
    ('index', 'Represent', 'Represent Documentation',
     [AUTHOR], 1)
]
...
texinfo_documents = [
    ('index', 'Represent', 'Represent Documentation', AUTHOR, 'Represent',
